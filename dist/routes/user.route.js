...
import { GetAllUsersService, GetUserByIdService, UpdateUserService, DeleteUserService, SearchUsersService } from "../services/user.service.js";
const router = Router();
...
const userController = new UserController(getAllSvc, getByIdSvc, updateSvc, deleteSvc, searchSvc);
/**
 * @swagger
 * tags:
 *   name: Users
