...
const token = jwt.sign({ id: "11111111-1111-1111-1111-111111111111", role: "USER" }, process.env.JWT_SECRET || "secret_kunci_rahasia");
...
describe("POST /api/products", () => {
    ...
    it("should create product successfully", async () => {
        const res = await request(app)
            ...
            .attach("image", Buffer.from("iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR4nGNgYAAAAAMAASsJTYQAAAAASUVORK5CYII=", "base64"), { filename: "test.png", contentType: "image/png" });
